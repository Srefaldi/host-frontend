    ...
    if (selectedOption === "C") {
      ...
      Swal.fire({
        ...
        html: `Pilihan Anda <strong>${getOptionText(
          selectedOption
        )}</strong> bukan sintaks untuk komentar satu baris di C#. Coba tinjau kembali materi tentang sintaks komentar di C# dan perhatikan simbol yang benar. Yuk, coba lagi!`,
        icon: "error",
